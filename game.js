...
var _user$project$GameState$GameState = F2(
	function (a, b) {
		return {gameScreen: a, clickCount: b};
	});
var _user$project$GameState$GameScreenClicked = {ctor: 'GameScreenClicked'};

var _user$project$TitleScreen$titleScreen = A2(
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$src('images/title_screen.png')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('I can do it. I will do it nine times.')
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('(click the button to start)')
						]))
				]))
		]));
...
var _user$project$GameOverScreen$gameOverScreen = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('gameScreen')
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('gameScreen__image'),
					_elm_lang$html$Html_Attributes$src('images/game_over.png')
				]),
			_elm_lang$core$Native_List.fromArray(
				[])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(9),
						'!'))
				])),
			A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('gameScreen__victoryMessage')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Have a trophy.')
				])),
			A2(
			_elm_lang$html$Html$button,
			_elm_lang$core$Native_List.fromArray(
...
var Elm = {};
Elm['Game'] = Elm['Game'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Game'], 'Game', typeof _user$project$Game$main === 'undefined' ? null : _user$project$Game$main);
